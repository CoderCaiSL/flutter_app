...
class MyLoginWidget extends StatefulWidget {
  @override
  MyLoginWidgetState createState() => new MyLoginWidgetState();
}

class MyLoginWidgetState extends State<MyLoginWidget> {

  final scaffoldState = GlobalKey<ScaffoldState>();
  var demonPlugin=new MethodChannel('jump/plugin');
  ...
  void initState() {
    ...
    //animationController = new AnimationController( duration:Duration(milliseconds: 2000),vsync:this);
...
*/
  ...
  @override
  void didUpdateWidget(MyLoginWidget oldWidget) {
                      ...
                      children: <Widget>[
                        ...
                        new Row(
                          ...
                          children: <Widget>[
                            InkWell(
                              onTap: () {
                                Map<String, String> map = { "flutter": "http://jzvd.nathen.cn/d525f756aabf4b0588c2152fb94e07f5/d9f59bef829a472a9ca066620d9b871a-5287d2089db37e62345123a1be272f8b.mp4" };
                                demonPlugin.invokeMethod('ACT',map);
                              },
                              child: Text(
                                'Forget pd',
                                style: TextStyle(
